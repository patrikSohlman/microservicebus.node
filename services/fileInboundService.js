...
var exports = module.exports = {
    ...
    Start : function () {
        try {
            this.Debug('File adapter started');
            ...
            dir = dir.replace(new RegExp('/\\/', 'g'), path.sep);
            dir = dir.replace(new RegExp('/', 'g'), path.sep);
                ...
                try {
                    fs.open(filePath, 'r', function (err, fd) {
                        fs.fstat(fd, function (err, stats) {
                            ...
                            // Replace backslashes with front slash if on windows
                            var filePathString  = filePath.replace(/\\/g,"/");
                            
                            var varaiables = [
                                { Variable: '_fullPath', Type: 'String', Value: filePathString },
                    ...
                    me.ThrowError(null, 00001, 'Error in file watcher. ' + ex.message);
            ...
            me.ThrowError(null, 00001, 'Error starting '.red + this.Name.red + '. ' + mainEx.message);
